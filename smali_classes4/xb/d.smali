...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lxb/d;->e:Ljava/nio/charset/Charset;
    ...
    sput-object v1, Lxb/d;->g:[B

    new-array v1, v0, [B

    fill-array-data v1, :array_2

    sput-object v1, Lxb/d;->h:[B

    new-array v1, v0, [B

    fill-array-data v1, :array_3

    sput-object v1, Lxb/d;->i:[B

    new-instance v1, Ljava/util/concurrent/ConcurrentHashMap;

    invoke-direct {v1, v0}, Ljava/util/concurrent/ConcurrentHashMap;-><init>(I)V

    sput-object v1, Lxb/d;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    sput-object v0, Lxb/d;->m:Ljava/text/DateFormat;
    ...
    sput-object v0, Lxb/d;->o:Ljava/time/format/DateTimeFormatter;

    const-string v0, ""

    sput-object v0, Lxb/d;->p:Ljava/lang/String;

    sput-object v0, Lxb/d;->q:Ljava/lang/String;

    sput-object v0, Lxb/d;->r:Ljava/lang/String;
...
.method public static C(Lxb/e;ILandroid/location/Location;JI)V
    .locals 2
    ...
    invoke-virtual {p0}, Lxb/e;->w0()V

    invoke-virtual {p0, p1}, Lxb/e;->y0(I)V

    :cond_0
    const-string p1, "Make"

    sget-object v0, Lxb/d;->p:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Lxb/e;->F0(Ljava/lang/String;Ljava/lang/String;)V

    const-string p1, "Model"

    sget-object v0, Lxb/d;->q:Ljava/lang/String;

    invoke-virtual {p0, p1, v0}, Lxb/e;->F0(Ljava/lang/String;Ljava/lang/String;)V

    sget-object p1, Lxb/d;->r:Ljava/lang/String;
    ...
    sget-object v0, Lxb/d;->r:Ljava/lang/String;
    ...
    invoke-virtual {p0, p1, p5}, Lxb/e;->F0(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p3, p4}, Lxb/d;->m(J)Ljava/lang/String;
    ...
    invoke-static {p3, p4}, Lxb/d;->r(J)Ljava/lang/String;
    ...
    invoke-virtual {p0, p3, p1}, Lxb/e;->F0(Ljava/lang/String;Ljava/lang/String;)V

    :cond_3
    invoke-virtual {p0, p2}, Lxb/e;->I0(Landroid/location/Location;)V
...
.method public static D(Ljava/io/FileDescriptor;ILandroid/location/Location;JI[B)V
    ...
    :cond_0
    invoke-static {p0}, Lxb/d;->A(Ljava/io/FileDescriptor;)Z
    ...
    invoke-direct {v0, v3}, Lxb/e;-><init>(Ljava/io/InputStream;)V
    :try_end_1
    ...
    :try_start_3
    invoke-static/range {v4 .. v9}, Lxb/d;->C(Lxb/e;ILandroid/location/Location;JI)V
    :try_end_3
    ...
    :try_start_6
    invoke-static {v5, v8}, Lxb/d;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_6
    .catch Ljava/io/IOException; {:try_start_6 .. :try_end_6} :catch_3
    .catch Landroid/system/ErrnoException; {:try_start_6 .. :try_end_6} :catch_3
    .catchall {:try_start_6 .. :try_end_6} :catchall_3

    invoke-static {v5}, Lxb/d;->b(Ljava/io/InputStream;)V

    invoke-static {v8}, Lxb/d;->c(Ljava/io/OutputStream;)V
    ...
    :try_start_9
    invoke-static {v5, v0, v6}, Lxb/d;->q(Ljava/io/OutputStream;Lxb/e;[B)Ljava/io/OutputStream;
    ...
    :try_start_a
    invoke-static {v3, v8}, Lxb/d;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_a
    .catch Ljava/io/IOException; {:try_start_a .. :try_end_a} :catch_1
    .catch Landroid/system/ErrnoException; {:try_start_a .. :try_end_a} :catch_1
    .catchall {:try_start_a .. :try_end_a} :catchall_1

    invoke-static {v3}, Lxb/d;->b(Ljava/io/InputStream;)V
...
.method public static E(Ljava/lang/String;ILandroid/location/Location;J)V
    ...
    invoke-static/range {v0 .. v5}, Lxb/d;->F(Ljava/lang/String;ILandroid/location/Location;J[B)V
...
.method public static F(Ljava/lang/String;ILandroid/location/Location;J[B)V
    ...
    invoke-static {p0}, Lxb/d;->z(Ljava/lang/String;)Z
    ...
    invoke-direct {v0, p0}, Lxb/e;-><init>(Ljava/lang/String;)V
    :try_end_0
    ...
    :try_start_1
    invoke-static/range {v2 .. v7}, Lxb/d;->C(Lxb/e;ILandroid/location/Location;JI)V
    :try_end_1
    ...
    :try_start_4
    invoke-static {p4, v0, p5}, Lxb/d;->q(Ljava/io/OutputStream;Lxb/e;[B)Ljava/io/OutputStream;

    move-result-object p2

    invoke-static {p3, p2}, Lxb/d;->d(Ljava/io/InputStream;Ljava/io/OutputStream;)J
    :try_end_4
    .catch Ljava/io/IOException; {:try_start_4 .. :try_end_4} :catch_0
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    :goto_0
    invoke-static {p3}, Lxb/d;->b(Ljava/io/InputStream;)V

    invoke-static {p4}, Lxb/d;->c(Ljava/io/OutputStream;)V
    ...
    :goto_4
    invoke-static {p2}, Lxb/d;->b(Ljava/io/InputStream;)V
...
.method public static G([BLxb/e;)[B
    .locals 1

    const/4 v0, 0x0

    invoke-static {p0, p1, v0}, Lxb/d;->H([BLxb/e;[B)[B
...
.method public static H([BLxb/e;[B)[B
    .locals 4
    .param p2    # [B
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :try_start_0
    invoke-virtual {p1, p2}, Lxb/e;->J0([B)V

    invoke-virtual {p1, v2, v0}, Lxb/e;->B0(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    :goto_0
    invoke-static {v0}, Lxb/d;->c(Ljava/io/OutputStream;)V

    invoke-static {v2}, Lxb/d;->b(Ljava/io/InputStream;)V
...
.method public static final a()V
    ...
    sget-object v0, Lxb/d;->k:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static f(Ljava/io/File;)Lxb/e;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lxb/e;-><init>(Ljava/io/File;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static g(Ljava/io/FileDescriptor;)Lxb/e;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lxb/e;-><init>(Ljava/io/FileDescriptor;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static h(Ljava/io/InputStream;)Lxb/e;
    .locals 1
    ...
    invoke-static {p0, v0}, Lxb/d;->i(Ljava/io/InputStream;I)Lxb/e;
...
.method public static i(Ljava/io/InputStream;I)Lxb/e;
    .locals 1
    .param p0    # Ljava/io/InputStream;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-direct {v0, p0, p1}, Lxb/e;-><init>(Ljava/io/InputStream;I)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static j(Ljava/lang/String;)Lxb/e;
    .locals 1
...
.method public static k([B)Lxb/e;
    .locals 1
    .param p0    # [B
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    invoke-static {v0, p0}, Lxb/d;->i(Ljava/io/InputStream;I)Lxb/e;

    move-result-object p0

    invoke-static {v0}, Lxb/d;->b(Ljava/io/InputStream;)V

    return-object p0
.end method

.method public static l(Lxb/b;)[B
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    :cond_0
    invoke-virtual {p0}, Lxb/b;->a()I

    move-result v2

    sget-object v3, Lxb/d;->k:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v5, p0}, Lxb/d$a;-><init>(Lxb/b;)V
    ...
    invoke-virtual {p0, v7, v8}, Lxb/b;->seek(J)V
    ...
    invoke-static {v0, v10, v1, v9}, Lxb/d;->I([BIILjava/nio/ByteOrder;)V

    invoke-virtual {p0, v7, v8}, Lxb/b;->seek(J)V

    invoke-virtual {p0, v0, v6, v5}, Lxb/b;->read([BII)I
...
.method public static m(J)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lxb/d;->n(JLjava/util/TimeZone;)Ljava/lang/String;
...
.method public static n(JLjava/util/TimeZone;)Ljava/lang/String;
    ...
    sget-object v0, Lxb/d;->m:Ljava/text/DateFormat;
...
.method public static q(Ljava/io/OutputStream;Lxb/e;[B)Ljava/io/OutputStream;
    .locals 2
    .param p2    # [B
        .annotation build Landroidx/annotation/Nullable;
        .end annotation
    ...
    :cond_0
    invoke-virtual {p1, p0, p2}, Lxb/e;->w(Ljava/io/OutputStream;[B)Ljava/io/OutputStream;
...
.method public static r(J)Ljava/lang/String;
    ...
    invoke-static {p0, p1, v0}, Lxb/d;->s(JLjava/util/TimeZone;)Ljava/lang/String;
...
.method public static s(JLjava/util/TimeZone;)Ljava/lang/String;
    ...
    sget-object p1, Lxb/d;->o:Ljava/time/format/DateTimeFormatter;
...
.method public static u([B)I
    ...
    invoke-static {v1}, Lxb/d;->t(Ljava/io/BufferedInputStream;)I
    ...
    invoke-static {p0}, Lxb/d;->k([B)Lxb/e;
...
.method public static v([B)I
    ...
    :cond_2
    invoke-static {p0, v2, v8, v0}, Lxb/d;->B([BIIZ)I
    ...
    invoke-static {p0, v1, v4, v0}, Lxb/d;->B([BIIZ)I
    ...
    invoke-static {p0, v1, v8, v0}, Lxb/d;->B([BIIZ)I
    ...
    invoke-static {p0, v9, v4, v2}, Lxb/d;->B([BIIZ)I
    ...
    invoke-static {p0, v4, v8, v2}, Lxb/d;->B([BIIZ)I
    ...
    invoke-static {p0, v1, v8, v2}, Lxb/d;->B([BIIZ)I
...
.method public static w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    sput-object p0, Lxb/d;->p:Ljava/lang/String;

    sput-object p1, Lxb/d;->q:Ljava/lang/String;

    sput-object p2, Lxb/d;->r:Ljava/lang/String;
...
.method public static x([B)Z
    ...
    invoke-direct {v1, p0}, Lxb/b;-><init>([B)V
    :try_end_0
    ...
    invoke-virtual {v1, v2}, Lxb/b;->d(Ljava/nio/ByteOrder;)V

    invoke-virtual {v1}, Lxb/b;->readInt()I
    ...
    invoke-virtual {v1}, Lxb/b;->readLong()J
